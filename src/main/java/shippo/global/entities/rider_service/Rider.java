...
public class Rider {
    ...
    private Boolean is_synced_tookan;
    ...
    public Boolean getIs_synced_tookan() {
        return is_synced_tookan;
    }

    public void setIs_synced_tookan(Boolean is_synced_tookan) {
        this.is_synced_tookan = is_synced_tookan;
    }
...
//                Objects.equals(getUpdatedAt(), rider.getUpdatedAt()) &&
    ...
    public String toString() {
        return "Rider{" +
                ...
                ", userId=" + userId +
                ", version=" + version +
                ", is_synced_tookan=" + is_synced_tookan +
                '}';
    }
