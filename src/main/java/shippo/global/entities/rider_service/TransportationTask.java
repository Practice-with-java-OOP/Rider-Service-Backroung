...
//	private List<ReasonCode> reasonCode;
	...
	private boolean eqReasonCodes(List<ReasonCode> reasonCodes1,List<ReasonCode> reasonCodes2){
		if(reasonCodes1 == null){
			return reasonCodes2 == null;
		}
		if(reasonCodes2 == null){
			return reasonCodes1 == null;
		}

		JSONArray jsonArray1 = new JSONArray(reasonCodes1);
		JSONArray jsonArray2 = new JSONArray(reasonCodes2);

		return  jsonArray1.toString().equals(jsonArray2.toString());
	}
